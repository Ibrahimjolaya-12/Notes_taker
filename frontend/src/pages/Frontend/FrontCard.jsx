  ...
  const items = [
    {
      ...
      description: "CS, MATH, PHY, IS, ENG, STATS — and any you add."
    },
    {
      id: 2,
      icon: (
      ...
      description: "PDFs, slides, videos, images, text — previewed in-browser."
    },
    {
      id: 3,
      icon: (
      ...
      description: "Find any note, tag, or topic across all subjects."
    },
    {
      id: 4,
      icon: (
      ...
      title: "Tags & topics",
      description: "Filter by chapter, week, or topic."
    },
    {
      id: 5,
      icon: (
      ...
      title: "AI summaries",
      description: "Summarize any PDF or note in one click."
    },
    {
      id: 6,
      icon: (
      ...
      title: "AI Tools Hub",
      description: "Quick links to NotebookLM, Gemini, Claude, ChatGPT."
    }
  ]
