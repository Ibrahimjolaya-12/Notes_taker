          ...
          {loading ? (
                ...
                >
                  ...
                  >
                    {todo.location && (
                      ...
                      >
                        <EnvironmentOutlined style={{ color: isDarkMode ? "#64748b" : "#94a3b8" }} />
                        <span>{todo.location}</span>
                      </div>
                    )}
                    <div
                    ...
                    >
                      <CalendarOutlined style={{ color: isDarkMode ? "#64748b" : "#94a3b8" }} />
                      <span>
                        {todo.dueDate
                          ? new Date(todo.dueDate).toLocaleDateString(
                              "en-US",
                  ...
                  >
                    <button
                      ...
                      style={{
                        ...
                        height: "32px",
                        borderRadius: "8px",
                        border: isDarkMode ? "1px solid #1e2652" : "1px solid #bae6fd",
                    ...
                    <button
                      ...
                      style={{
                        ...
                        height: "32px",
                        borderRadius: "8px",
                        border: isDarkMode ? "1px solid #1e2652" : "1px solid #fde68a",
                    ...
                    >
                      <button
                        ...
                        style={{
                          ...
                          border: isDarkMode ? "1px solid rgba(244, 63, 94, 0.25)" : "1px solid #fecaca",
            ...
            <div
              style={{
                ...
                borderRadius: "16px",
                overflow: "hidden",
                boxShadow: isDarkMode ? "0 10px 30px rgba(0, 0, 0, 0.4)" : "0 4px 16px rgba(0, 0, 0, 0.04)",
                transition: "all 0.3s ease",
              }}
            >
              <div style={{ overflowX: "auto" }}>
                  ...
                  <tbody>
                    {paginatedTodos.map((todo, index) => (
                      <tr
                        key={todo._id || index}
                        style={{
                          borderBottom: isDarkMode ? "1px solid #141b3d" : "1px solid #f1f5f9",
                          transition: "background 0.2s ease",
                        }}
                        onMouseEnter={(e) =>
                          (e.currentTarget.style.backgroundColor = isDarkMode ? "#121838" : "#f8fafc")
                        }
                        onMouseLeave={(e) =>
            ...
            <Row gutter={[12, 12]} style={{ marginBottom: "14px" }}>
              <Col span={isMobile ? 24 : 12}>
                ...
                >
                  ...
                  >
                    <EnvironmentOutlined style={{ color: "#6366f1" }} /> Location
                  </span>
                  <p
                    style={{
                      margin: "4px 0 0",
